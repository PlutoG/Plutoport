...
contextual_css_edit();window.setTimeout(contextual_css_edit,2000);var url_patterns=[{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=catalogues&type=category&id=([^&]*)/,hook:'catalogue_category'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_catalogues&type=_ec&id=([^&]*)/,hook:'catalogue_category'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=catalogues&type=entry&id=([^&]*)/,hook:'catalogue_entry'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_catalogues&type=_ed&id=([^&]*)/,hook:'catalogue_entry'},{pattern:/^http:\/\/localhost:47370\/\/([^&]*)\/?index.php\?page=([^&]*)/,hook:'comcode_page'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_comcode_pages&type=_ed&id=([^&]*)/,hook:'comcode_page'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=downloads&type=entry&id=([^&]*)/,hook:'download'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_downloads&type=_ed&id=([^&]*)/,hook:'download'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=downloads&type=misc&id=([^&]*)/,hook:'download_category'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_downloads&type=_ec&id=([^&]*)/,hook:'download_category'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=calendar&type=view&id=([^&]*)/,hook:'event'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_calendar&type=_ed&id=([^&]*)/,hook:'event'},{pattern:/^http:\/\/localhost:47370\/\/forum\/index.php\?page=forumview&type=misc&id=([^&]*)/,hook:'forum'},{pattern:/^http:\/\/localhost:47370\/\/adminzone\/index.php\?page=admin_ocf_forums&type=_ec&id=([^&]*)/,hook:'forum'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=galleries&type=misc&id=([^&]*)/,hook:'gallery'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_galleries&type=_ec&id=([^&]*)/,hook:'gallery'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=groups&type=view&id=([^&]*)/,hook:'group'},{pattern:/^http:\/\/localhost:47370\/\/adminzone\/index.php\?page=admin_ocf_groups&type=_ed&id=([^&]*)/,hook:'group'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=galleries&type=image&id=([^&]*)/,hook:'image'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_galleries&type=_ed&id=([^&]*)/,hook:'image'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=members&type=view&id=([^&]*)/,hook:'member'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=news&type=view&id=([^&]*)/,hook:'news'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_news&type=_ed&id=([^&]*)/,hook:'news'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=polls&type=view&id=([^&]*)/,hook:'poll'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_polls&type=_ed&id=([^&]*)/,hook:'poll'},{pattern:/^http:\/\/localhost:47370\/\/forum\/index.php\?page=topicview&type=findpost&id=([^&]*)/,hook:'post'},{pattern:/^http:\/\/localhost:47370\/\/forum\/index.php\?page=topics&type=edit_post&id=([^&]*)/,hook:'post'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=quiz&type=do&id=([^&]*)/,hook:'quiz'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_quiz&type=_ed&id=([^&]*)/,hook:'quiz'},{pattern:/^http:\/\/localhost:47370\/\/forum\/index.php\?page=topicview&type=misc&id=([^&]*)/,hook:'topic'},{pattern:/^http:\/\/localhost:47370\/\/forum\/index.php\?page=topics&type=edit_topic&id=([^&]*)/,hook:'topic'},{pattern:/^http:\/\/localhost:47370\/\/site\/index.php\?page=galleries&type=video&id=([^&]*)/,hook:'video'},{pattern:/^http:\/\/localhost:47370\/\/cms\/index.php\?page=cms_galleries&type=_ev&id=([^&]*)/,hook:'video'}];var cells=document.getElementsByTagName('td');var links=[];if(window.location.href.indexOf('/cms/')!=-1)
...
{link.is_over=true;var request=do_ajax_request(maintain_theme_in_link('//data/comcode_convert.php?css=1&javascript=1&box_title=Preview'+keep_stub(false)),function(ajax_result_frame,ajax_result){if(ajax_result)
...
{on_url='http://localhost:47370//themes/default/images/footer/managementmenu.png'.replace(/^https?:/,window.location.protocol);off_url='http://localhost:47370//themes/default/images/footer/managementmenu.png'.replace(/^https?:/,window.location.protocol);}else
{on_url='http://localhost:47370//themes/default/images/footer/bookmarksmenu.png'.replace(/^https?:/,window.location.protocol);off_url='http://localhost:47370//themes/default/images/footer/bookmarksmenu.png'.replace(/^https?:/,window.location.protocol);}
...
img=document.getElementById(type+'_menu_img');set_opacity(img,0.4);tmp_element=document.createElement('img');tmp_element.style.position='absolute';tmp_element.style.left=find_pos_x(img)+'px';tmp_element.style.top='9px';tmp_element.id=type+'_menu_img_loader';tmp_element.src='http://localhost:47370//themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol);img.parentNode.appendChild(tmp_element);require_javascript('javascript_ajax');require_javascript('javascript_menu_popup');window.setTimeout(function(){load_management_menu(type,no_confirm_needed);},200);return false;}
...
{cancel_bubbling(event);if(typeof event.preventDefault!='undefined')event.preventDefault();var html=' \
  ...
  <iframe class="ocp_chat_iframe" frameborder="0" border="0" src="http://chat.zoho.com/shout.sas?k=%7B%22g%22%3A%22Anonymous%22%2C%22c%22%3A%2299b05040669de8c406b674d2366ff9b0401fe3523f0db988%22%2C%22o%22%3A%22e89335657fd675dcfb8e555ea0615984%22'+'%7D'+'&amp;chaturl=ocPortal%20chat&amp;V=000000-70a9e1-eff4f9-70a9e1-ocPortal%20chat&amp;user=%28unnamed%29'+((typeof window.ocp_username!='undefined')?window.encodeURIComponent('/'+window.ocp_username):'')+'&amp;participants=true"></iframe> \
...
{new Image().src='http://localhost:47370//themes/default/images/checklist/cross2.png';new Image().src='http://localhost:47370//themes/default/images/checklist/toggleicon2.png';var checklist_rows=get_elements_by_class_name(document,'checklist_row'),row_imgs,src;for(var i=0;i<checklist_rows.length;i++)
...
{load_snippet('checklist_task_manage&type=mark_done&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_undone(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','http://localhost:47370//themes/default/images/checklist/checklist1.png');}
function mark_undone(ob,id)
{load_snippet('checklist_task_manage&type=mark_undone&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_done(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','http://localhost:47370//themes/default/images/checklist/not_completed.png');}
