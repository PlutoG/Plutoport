...
"use strict";new Image().src='http://localhost:47370//themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol);function password_strength(ob)
...
{var test=form.onsubmit.call(form,event);if(!test)return false;}
...
if(((the_class=='input_username')||(the_class=='input_username_required'))&&(my_value!='')&&(my_value!='****')&&(window.do_ajax_field_test)&&(!do_ajax_field_test('//data/username_exists.php?username='+encodeURIComponent(my_value))))
...
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('expand','contract'):'http://localhost:47370//themes/default/images/contract.png').replace(/^https?:/,window.location.protocol);pic.setAttribute('alt','Contract');pic.setAttribute('title','Contract');new_state=(field_input.nodeName.toLowerCase()=='tr')?'table-row':'block';new_state_2='block';new_state_3='1px dashed';}else
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('contract','expand'):'http://localhost:47370//themes/default/images/expand.png').replace(/^https?:/,window.location.protocol);pic.setAttribute('alt','Expand');pic.setAttribute('title','Expand');new_state='none';new_state_2='none';new_state_3='0';}
